...
description: "通达信股票数据分析技能 - 提供某只股票基本信息、K线、MACD、BOLL、KDJ,RSI、技术信号等技术指标查询，公司资料获取（包括：公司概况、财务分析、股本结、股东研究、机构持股、分红融资、高管治理、资金动向、资本运作、公司公告、公司报道、经营分析、研报评级等），并可以通过金叉、死叉、超买、超卖等信号进行股票筛选的功能"
license: MIT
metadata:
...
2. **公司F10资料查询** - 获取公司概况、财务分析、股本结、股东研究、机构持股、分红融资、高管治理、资金动向、资本运作、公司公告、公司报道、经营分析、研报评级等详细信息，并转换为Markdown格式
3. **股票信号筛选** - 根据技术指标信号（金叉、死叉、超买、超卖）筛选股票

## 激活时机

当用户询问以下类型的问题时，该技能会被激活：

1. **股票信息查询** - 查询某只股票的行情、财务数据、技术指标等
2. **公司资料查询** - 查询上市公司的F10资料、公司概况、财务分析等
3. **股票筛选** - 根据技术指标信号（金叉、死叉、超买、超卖）筛选股票
4. **技术指标分析** - 询问MACD、KDJ、RSI、BOLL等技术指标相关问题
5. **通达信数据** - 提及通达信行情数据的查询需求

**典型触发场景：**
- "帮我查一下贵州茅台的股票信息"
- "看看这只股票的技术指标怎么样，帮我判断一下后市走势"
- "从我的关注列表中查询最近出现金叉的股票"
- "给我看看这家公司的财务分析"
